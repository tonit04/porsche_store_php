...
<head>
    ...
    <style>
        ...
        .porsche-css-logo-circle {
            ...
            /* Màu đen đặc trưng của Porsche */
            border: 5px solid white;
            /* Thêm viền  */
            display: flex;
            /* Để căn giữa nội dung nếu có */
            justify-content: center;
            align-items: center;
            flex-shrink: 0;
            /* Ngăn không cho logo bị co lại trên màn hình nhỏ */
        }

        /* CSS cho logo hình tròn ở footer (nếu bạn muốn kích thước khác) */
        .porsche-css-logo-circle-footer {
            width: 30px;
            /* Kích thước lớn hơn cho footer */
            height: 30px;
            border-radius: 150%;
            background-color: rgb(0, 0, 0);
            /* Màu đỏ */
        ...
        .porsche-header .search-input::placeholder {
...
<body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTFyZV9fBUHhXLBLwG5gPddPbDdmNklfFNL5bqPNxHA/3t7fQ" crossorigin="anonymous"></script>
